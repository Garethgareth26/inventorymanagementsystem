{{--
    Safety Stock Index — Skeleton (Sprint 2.1.5)
    ────────────────────────────────────────────
--}}
<x-layout.app
    pageTitle="Safety Stock"
    pageSubtitle="Persediaan Pengaman — Tentukan buffer persediaan untuk menghindari stockout akibat variabilitas permintaan"
>
    <!-- Filter & Toolbar -->
    <div class="mb-lg">
        <x-forms.filter-bar>
    ...
    <div class="mb-lg">
        <x-tables.data-table
            :headers="['Kode', 'Nama Bahan Baku', 'Kelas ABC', 'SD Harian', 'Lead Time', 'Z (Service Level)', 'Current SS', 'Aksi']"
            :items="[1, 2]"
        >
            <!-- Row 1 -->
            <tr class="hover:bg-surface-container-low transition-colors duration-150">
                ...
                <td class="px-lg py-md font-tabular-nums text-text-primary">12.50 kg</td>
                <td class="px-lg py-md font-tabular-nums text-text-primary">4 Hari</td>
                <td class="px-lg py-md font-tabular-nums text-text-primary">1.65 (95%)</td>
                <td class="px-lg py-md font-tabular-nums text-text-primary font-bold">41.25 kg</td>
                <td class="px-lg py-md">
            ...
            <tr class="hover:bg-surface-container-low transition-colors duration-150">
                ...
                <td class="px-lg py-md font-tabular-nums text-text-primary">8.20 kg</td>
                <td class="px-lg py-md font-tabular-nums text-text-primary">4 Hari</td>
                <td class="px-lg py-md font-tabular-nums text-text-primary">1.65 (95%)</td>
                <td class="px-lg py-md font-tabular-nums text-text-primary font-bold">27.06 kg</td>
                <td class="px-lg py-md">
                    <button class="flex items-center justify-center gap-2 rounded-full border border-primary-container text-primary font-label-sm text-label-sm px-md py-sm hover:bg-primary-fixed/40 transition-all duration-150 active:scale-[0.98]">
                        <span class="material-symbols-outlined text-[16px]">calculate</span>
                        Simulate
